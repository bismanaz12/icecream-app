        ...
        children:[ Container(
          child: Column(
            ...
            children: [
              ...
              Align(
                ...
                }, icon: Icon(Icons.arrow_back_ios,color: Color.fromARGB(255, 227, 65, 122),size: 30,)),
              ),
               SizedBox(height: 20,),
              ...
              Padding(
                ...
                child: Align(
                  alignment: Alignment.topLeft,
                  child: Text('Candy Flavours',style: TextStyle(
         ...
         Positioned(
          ...
          child: Container(
            ...
            child: Image.asset('assets/images/mycandy.png',height: 500,))),
             AnimatedPositioned(
              right: animate?0:-200,
              top: 450,
            ...
            Padding(
              ...
              child: Row(
                children: [
                  ...
                  SizedBox(width: 7,),
                  Text('Chocolate',style: TextStyle(color: Color.fromARGB(255, 234, 114, 206),fontSize: 20,),),
                ],
              ),
            ),
             Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.check_box_outline_blank,color: Colors.pink,),
                  SizedBox(width: 7,),
                  Text('Vanilla',style: TextStyle(color: Color.fromARGB(255, 234, 114, 206),fontSize: 20,),),
                ],
              ),
            ),
           Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.check_box_outline_blank,color: Colors.pink,),
                  SizedBox(width: 7,),
                  Text('Friuti',style: TextStyle(color: Color.fromARGB(255, 234, 114, 206),fontSize: 20,),),
                ],
              ),
            ),
            Padding(
            ...
            Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.check_box_outline_blank,color: Colors.pink,),
                  SizedBox(width: 7,),
                  Text('Kulfa',style: TextStyle(color: Color.fromARGB(255, 234, 114, 206),fontSize: 20,),),
                ],
              ),
            ),
         Padding(
        ...
        Padding(
              ...
              child: Row(
                children: [
                  Icon(Icons.check_box_outline_blank,color: Colors.pink,),
                  SizedBox(width: 7,),
                  Text('Strawberry',style: TextStyle(color: Color.fromARGB(255, 234, 114, 206),fontSize: 20,),),
                ],
              ),
            ),
             Padding(
