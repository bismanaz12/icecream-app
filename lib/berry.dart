...
class Berry extends StatefulWidget {
  const Berry({super.key});

  @override
  State<Berry> createState() => _BerryState();
}

class _BerryState extends State<Berry> {
  int quantity=0;
  @override
          ...
          children:[ Container(
            ...
            child: Column(
              children: [
                ...
                Image.asset('assets/images/berry.png',height: 260,),
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            child: Text(
                              'Berry Licious Ice Cream like other flavours made of cooling mixture of Suger,Original Cream,Fruits and Coconut',
                              style: TextStyle(
