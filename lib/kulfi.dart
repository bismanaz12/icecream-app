...
class Kulfi extends StatefulWidget {
   Kulfi({super.key});

  @override
  State<Kulfi> createState() => _KulfiState();
}

class _KulfiState extends State<Kulfi> {
int quantity = 0;
          ...
          children:[ Container(
            ...
            child: Column(
              children: [
                ...
                Image.asset('assets/images/kulf.png',height: 260,),
                Expanded(
                  child: Container(
                    ...
                    child: Column(
                      children: [
                        ...
                        Padding(
                          ...
                          child: Container(
                            child: Text(
                              'Kulfi Ice Cream like other flavours made of cooling mixture of Suger,Original Cream,Fruits and Coconut',
                              style: TextStyle(
                                 fontFamily: 'Main',
